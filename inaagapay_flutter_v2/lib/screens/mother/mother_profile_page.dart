...
class _MotherProfilePageState extends State<MotherProfilePage>
  ...
  Widget _buildUltrasoundCard(Map<String, dynamic> ultrasound) {
    final addedDate =
        _formatDateTime(ultrasound['created_at'] ?? ultrasound['createdAt']);
    ...
    return UltrasoundRecordCard(
      ...
      onTap: () async {
        ...
        _showRecordDetails(
          title: 'Ultrasound',
          subtitle: '${_t('Added on', 'Inayos noong')} $addedDate',
          icon: Icons.monitor_heart,
          imageUrls: imageUrls.isNotEmpty ? imageUrls : null,
          rows: [
            MapEntry(_t('Record Added', 'Pinasok Noong'), addedDate),
            MapEntry(
  ...
  Widget _buildLabTestCard(Map<String, dynamic> labTest) {
    final addedDate =
        _formatDateTime(labTest['created_at'] ?? labTest['createdAt']);
