...
class _ChildProfilePageState extends State<ChildProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final age = calculateAge(birthData?['birthdate']);
          ...
          child: Column(
            children: [
              ...
              RecordsDisplayCard(
                ...
                items: [
                  ...
                  RecordItem(
                    ...
                    label: 'Birthplace',
                    value: birthPlace.isNotEmpty ? birthPlace : 'Not recorded',
                  ),
                  RecordItem(
              ...
              MainButton(
                ...
                onPressed: () {
                  // TODO: Navigate to add growth record
                },
              ...
              MainButton(
                ...
                onPressed: () {
                  // TODO: Navigate to add immunization
                },
                leftIcon: Icons.vaccines_outlined,
              ),
