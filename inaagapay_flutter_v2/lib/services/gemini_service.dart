...
class GeminiService {
  ...
  // Updated method for analyzing multiple ultrasound images with health assessment
...
""";
  ...
  Future<GeminiResponse> analyzeImage(XFile imageFile) async {
    final apiKey = dotenv.env['GEMINI_API_KEY'];
    if (apiKey == null || apiKey.isEmpty) {
      throw Exception('Gemini API Key not found in .env');
    }
    
    final singlePrompt = "Describe this image in detail. What do you see? Be specific and descriptive.";
